...
(defun csound-sco-uncomment-all-instruments ()
  ...
  (save-excursion
    (goto-char (csound-sco-point-min))
    (while (re-search-forward (format "^%s \"?\\w+\"? " csound-sco-muter) 
