...
(setq csound-reference-re (regexp-opt csound-reference 'words)) 
...
(setq csound-syntactic-re (regexp-opt csound-syntactic 'words))
...
(setq csound-font-lock-keywords
	`( 
	 ...
	 (,csound-reference-re . font-lock-reference-face)
	 ...
	 (,csound-syntactic-re . font-lock-syntactic-face)
...
(defun csound-execute-csound ()
  (interactive)
  (save-buffer)
  (setq command-line (concat "csound " (buffer-file-name)))
  (shell-command command-line "*csound output*")
)

(defun csound-insert-sine-table ()
  (interactive)
  (insert "sine table")
)
...
(defun csound-mode-keys ()
  (interactive)
  (local-set-key (kbd "<f5>") 'csound-execute-csound)
  (local-set-key (kbd "<f6>") 'csound-insert-sine-table)
)
